...
function CalculateDueDate(submitDate, turnaroundTime) {
    ...
    var overturnHours = submitDate.getHours() + (turnaroundTime % numOfWorkingHours) - workingDayStartHour;
    ...
    var weekends = Math.trunc((submitDate.getDay() + days - 1) / numOfWorkingDays);
...
try {
    var submitDate = new Date("2019-12-13 16:01:01");
    var turnaroundTime = 161;
